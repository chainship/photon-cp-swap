...
use photon_cp_swap::accounts as photon_cp_accounts;
use photon_cp_swap::instruction as photon_cp_instructions;
use photon_cp_swap::{
...
pub fn initialize_pool_instr(
    ...
    let program = client.program(config.photon_cp_program)?;
    ...
    let mut instructions = program
        .request()
        .accounts(photon_cp_accounts::Initialize {
        ...
        .args(photon_cp_instructions::Initialize {
            init_amount_0,
            init_amount_1,
            open_time,
        })
...
pub fn deposit_instr(
    ...
    let instructions = program
        .request()
        .accounts(photon_cp_accounts::Deposit {
            owner: program.payer(),
            authority,
            pool_state: pool_id,
        ...
        .args(photon_cp_instructions::Deposit {
            lp_token_amount,
...
pub fn withdraw_instr(
    ...
    let instructions = program
        .request()
        .accounts(photon_cp_accounts::Withdraw {
            owner: program.payer(),
            authority,
            pool_state: pool_id,
            owner_lp_token: user_token_lp_account,
        ...
        .args(photon_cp_instructions::Withdraw {
            lp_token_amount,
...
pub fn swap_base_input_instr(
    ...
    let instructions = program
        .request()
        .accounts(photon_cp_accounts::Swap {
            payer: program.payer(),
            authority,
            amm_config,
            pool_state: pool_id,
        ...
        .args(photon_cp_instructions::SwapBaseInput {
            amount_in,
            minimum_amount_out,
        })
        .instructions()?;
...
pub fn swap_base_output_instr(
    ...
    let instructions = program
        ...
        .args(photon_cp_instructions::SwapBaseOutput {
            max_amount_in,
            amount_out,
        })
        .instructions()?;
