...
solana_security_txt::security_txt! {
    name: "photon-cp-swap",
    project_url: "https://photon.io",
    contacts: "email:security@photon.io",
    policy: "https://photon.io/security",
    source_code: "https://github.com/yourusername/photon-cp-swap",
    preferred_languages: "en",
    auditors: "N/A"
}

#[cfg(feature = "devnet")]
declare_id!("BX3Agat82KQeiV1Gzk91Y5kd3sBVLwjvRt8pVLJVmGDd");
